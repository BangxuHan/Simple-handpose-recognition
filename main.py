    ...
    if is_videos:
        ...
        while True:
            ...
            if ret:  # 读取相机图像成功
                ...
                # 检测每个手的关键点及相关信息
                tracking.handpose_keypoints21(img, algo_img, handpose_model=handpose_model, gesture_model=gesture_model,
                                              vis=True)
                et_ = time.time()
                print('单帧耗时：', et_ - st_)
                fps_ = 1. / (et_ - st_ + 1e-8)
        ...
        for img_name in os.listdir(test_path):
            ...
            for h_box in hand_bbox:
                ...
                print(gesture_name)
                cv2.putText(img, 'LABEL {}'.format(gesture_name), (int(x_min + 2), int(y_min + 5)),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_path', type=str, default='/home/kls/data/hand_pose/handpose_data/handpose_x_gesture_v1/000-one',
    ...
    parser.add_argument('--video_path', type=str, default='939171652.mp4', help='0 for cam/path ')  # 是否视频
